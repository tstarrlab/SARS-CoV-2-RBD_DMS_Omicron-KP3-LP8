...
```
    ...
    ##  [9] htmltools_0.5.2  utf8_1.2.2       rlang_1.1.6      pillar_1.7.0    
    ## [13] glue_1.6.2       withr_2.5.0      DBI_1.1.2        dbplyr_2.1.1    
    ## [17] modelr_0.1.8     readxl_1.3.1     lifecycle_1.0.3  munsell_0.5.0   
    ## [21] gtable_0.3.6     cellranger_1.1.0 rvest_1.0.2      evaluate_0.15   
...
```
    ...
    ## [1] "read:cell ratio for pool1 SortSeq_bin1 is 4.09380377514138"
    ## [1] "read:cell ratio for pool1 SortSeq_bin2 is 4.6999213061871"
    ## [1] "read:cell ratio for pool1 SortSeq_bin3 is 5.5693654075805"
    ## [1] "read:cell ratio for pool1 SortSeq_bin4 is 6.581550270983"
    ## [1] "read:cell ratio for pool2 SortSeq_bin1 is 2.16792248782948"
    ## [1] "read:cell ratio for pool2 SortSeq_bin2 is 2.9187489501681"
    ## [1] "read:cell ratio for pool2 SortSeq_bin3 is 3.94967453145911"
    ## [1] "read:cell ratio for pool2 SortSeq_bin4 is 4.31182880948085"
...
invisible(dt[library=="pool1",c("expression","ML_sdF") := tryCatch(calc.MLmean(b1=SortSeq_bin1*20,b2=SortSeq_bin2*20,
                                                                      ...
                                                                      min.b1=log(20),min.b2=log(432),min.b3=log(1178),
                                                                      min.b4=log(2631),max.b4=log(229000)),
...
We have generated expression measurements for 77.66% of the barcodes in
our libraries.
