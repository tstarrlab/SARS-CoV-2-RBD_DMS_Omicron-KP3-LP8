...
counts <- data.table(fread(config$variant_counts_file,stringsAsFactors=F))
...
dt_KP3 <- data.table(read.csv(file=config$codon_variant_table_file_KP3,stringsAsFactors=F))
dt_LP8 <- data.table(read.csv(file=config$codon_variant_table_file_LP8,stringsAsFactors=F))

#merge, eliminate barcodes duplicated within a library
dt <- rbind(dt_KP3,dt_LP8); setkey(dt,barcode,library)
...
dt <- merge(counts, dt, by=c("library","barcode")); rm(dt_KP3);rm(dt_LP8);rm(counts); rm(duplicates)
...
```
    ...
    ## [1] "read:cell ratio for pool1 TiteSeq_01_bin1 is 4.43217517745885"
    ## [1] "read:cell ratio for pool1 TiteSeq_01_bin2 is 4.2408818275986"
    ## [1] "read:cell ratio for pool1 TiteSeq_01_bin3 is 4.44279446365036"
    ## [1] "read:cell ratio for pool1 TiteSeq_01_bin4 is 4.47702148273629"
    ## [1] "read:cell ratio for pool1 TiteSeq_02_bin1 is 4.75816257622489"
    ## [1] "read:cell ratio for pool1 TiteSeq_02_bin2 is 4.27903856903298"
    ## [1] "read:cell ratio for pool1 TiteSeq_02_bin3 is 2.90889059511628"
    ## [1] "read:cell ratio for pool1 TiteSeq_02_bin4 is 3.91393934497271"
    ## [1] "read:cell ratio for pool1 TiteSeq_03_bin1 is 3.9795116727475"
    ## [1] "read:cell ratio for pool1 TiteSeq_03_bin2 is 3.05064895692367"
    ## [1] "read:cell ratio for pool1 TiteSeq_03_bin3 is 4.59639007292709"
    ## [1] "read:cell ratio for pool1 TiteSeq_03_bin4 is 5.18425987091092"
    ## [1] "read:cell ratio for pool1 TiteSeq_04_bin1 is 5.19737343005456"
    ## [1] "read:cell ratio for pool1 TiteSeq_04_bin2 is 4.20775578186809"
    ## [1] "read:cell ratio for pool1 TiteSeq_04_bin3 is 3.5740514845295"
    ## [1] "read:cell ratio for pool1 TiteSeq_04_bin4 is 7.54286847061156"
    ## [1] "read:cell ratio for pool1 TiteSeq_05_bin1 is 4.93843160670851"
    ## [1] "read:cell ratio for pool1 TiteSeq_05_bin2 is 4.55895517016982"
    ## [1] "read:cell ratio for pool1 TiteSeq_05_bin3 is 9.01046158636258"
    ## [1] "read:cell ratio for pool1 TiteSeq_05_bin4 is 1.22084367245658"
    ## [1] "read:cell ratio for pool1 TiteSeq_06_bin1 is 4.51740306896015"
    ## [1] "read:cell ratio for pool1 TiteSeq_06_bin2 is 5.42831622499699"
    ## [1] "read:cell ratio for pool1 TiteSeq_06_bin3 is 3.11364046973803"
    ## [1] "read:cell ratio for pool1 TiteSeq_06_bin4 is 1.33618385889898"
    ## [1] "read:cell ratio for pool1 TiteSeq_07_bin1 is 5.30882042347837"
    ## [1] "read:cell ratio for pool1 TiteSeq_07_bin2 is 5.43516093519864"
    ## [1] "read:cell ratio for pool1 TiteSeq_07_bin3 is 1.54686346863469"
    ## [1] "read:cell ratio for pool1 TiteSeq_07_bin4 is 1.22778257118205"
    ## [1] "read:cell ratio for pool1 TiteSeq_08_bin1 is 5.08978496224882"
    ## [1] "read:cell ratio for pool1 TiteSeq_08_bin2 is 4.88585276514366"
    ## [1] "read:cell ratio for pool1 TiteSeq_08_bin3 is 1.41111754487551"
    ## [1] "read:cell ratio for pool1 TiteSeq_08_bin4 is 1.07457898957498"
    ## [1] "read:cell ratio for pool1 TiteSeq_09_bin1 is 4.53218376026429"
    ## [1] "read:cell ratio for pool1 TiteSeq_09_bin2 is 4.77996080460656"
    ## [1] "read:cell ratio for pool1 TiteSeq_09_bin3 is 1.00091996320147"
    ## [1] "reads < cells for pool1 TiteSeq_09_bin4 , un-normalized (ratio 0.585534591194969 )"
    ## [1] "read:cell ratio for pool2 TiteSeq_01_bin1 is 4.87702459378273"
    ## [1] "read:cell ratio for pool2 TiteSeq_01_bin2 is 1.69259793740965"
    ## [1] "read:cell ratio for pool2 TiteSeq_01_bin3 is 4.78551096408086"
    ## [1] "read:cell ratio for pool2 TiteSeq_01_bin4 is 4.65878070097084"
    ## [1] "read:cell ratio for pool2 TiteSeq_02_bin1 is 4.39750659314313"
    ## [1] "read:cell ratio for pool2 TiteSeq_02_bin2 is 3.99541585507681"
    ## [1] "read:cell ratio for pool2 TiteSeq_02_bin3 is 4.21852668151187"
    ## [1] "read:cell ratio for pool2 TiteSeq_02_bin4 is 3.88935663131572"
    ## [1] "read:cell ratio for pool2 TiteSeq_03_bin1 is 5.04996707414153"
    ## [1] "read:cell ratio for pool2 TiteSeq_03_bin2 is 4.54084930025827"
    ## [1] "read:cell ratio for pool2 TiteSeq_03_bin3 is 4.48193247724471"
    ## [1] "read:cell ratio for pool2 TiteSeq_03_bin4 is 5.78076622264156"
    ## [1] "read:cell ratio for pool2 TiteSeq_04_bin1 is 5.33068013709236"
    ## [1] "read:cell ratio for pool2 TiteSeq_04_bin2 is 5.30628331261719"
    ## [1] "read:cell ratio for pool2 TiteSeq_04_bin3 is 5.05916808266678"
    ## [1] "read:cell ratio for pool2 TiteSeq_04_bin4 is 4.77811806637398"
    ## [1] "read:cell ratio for pool2 TiteSeq_05_bin1 is 5.04325318876245"
    ## [1] "read:cell ratio for pool2 TiteSeq_05_bin2 is 4.28161108090712"
    ## [1] "read:cell ratio for pool2 TiteSeq_05_bin3 is 4.4290790118054"
    ## [1] "read:cell ratio for pool2 TiteSeq_05_bin4 is 1.8455847331153"
    ## [1] "read:cell ratio for pool2 TiteSeq_06_bin1 is 5.12082876161139"
    ## [1] "read:cell ratio for pool2 TiteSeq_06_bin2 is 5.65087080914419"
    ## [1] "read:cell ratio for pool2 TiteSeq_06_bin3 is 1.38473748473748"
    ## [1] "read:cell ratio for pool2 TiteSeq_06_bin4 is 1.52926562655272"
    ## [1] "read:cell ratio for pool2 TiteSeq_07_bin1 is 5.41030442180816"
    ## [1] "read:cell ratio for pool2 TiteSeq_07_bin2 is 5.63981096398347"
    ## [1] "read:cell ratio for pool2 TiteSeq_07_bin3 is 1.98045648077057"
    ## [1] "read:cell ratio for pool2 TiteSeq_07_bin4 is 1.04145395139882"
    ## [1] "read:cell ratio for pool2 TiteSeq_08_bin1 is 4.88555594782139"
    ## [1] "read:cell ratio for pool2 TiteSeq_08_bin2 is 4.96092854104531"
    ## [1] "read:cell ratio for pool2 TiteSeq_08_bin3 is 1.79236456047129"
    ## [1] "read:cell ratio for pool2 TiteSeq_08_bin4 is 1.86954500552037"
    ## [1] "read:cell ratio for pool2 TiteSeq_09_bin1 is 4.88389017451258"
    ## [1] "read:cell ratio for pool2 TiteSeq_09_bin2 is 6.88419018372425"
    ## [1] "read:cell ratio for pool2 TiteSeq_09_bin3 is 1.50218818380744"
    ## [1] "reads < cells for pool2 TiteSeq_09_bin4 , un-normalized (ratio 0.446527012127894 )"
...
We successfully generated *K*<sub>D</sub> estimates for 144369 of our
pool1 barcodes (70.56%), and 136331 of our pool2 barcodes (66.99%).
...
``` r
par(mfrow=c(3,1))
hist(log10(dt[target=="KP3",Kd_ACE2]),col="gray40",breaks=60,xlab="log10(KD), ACE2 (M)",main="KP3",xlim=c(-13,-5))
hist(log10(dt[target=="KP3" & variant_class %in% (c("synonymous","wildtype")),Kd_ACE2]),col="#92278F",add=T,breaks=60)
hist(log10(dt[target=="LP8",Kd_ACE2]),col="gray40",breaks=60,xlab="log10(KD), ACE2 (M)",main="LP8",xlim=c(-13,-5))
hist(log10(dt[target=="LP8" & variant_class %in% (c("synonymous","wildtype")),Kd_ACE2]),col="#92278F",add=T,breaks=60)
#save pdf
...
p1 <- ggplot(dt[!is.na(log10Ka),],aes(x=variant_class,y=log10Ka))+
  ...
  facet_wrap(~target+library,nrow=4)
...
We have generated binding measurements for 68.49% of the barcodes in our
libraries.
